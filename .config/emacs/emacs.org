...
[[https://www.gnu.org/software/hyperbole/][GNU Hyperbole]]: implicit buttons, HyRolo, Koutliner, HyWiki.

The Action Key ({M-RET}, {S-mouse-2}) acts on whatever is at point - file paths,
URLs, Org links, grep hits, stack traces. The Assist Key is {C-u M-RET}. The
full menu is on {C-h h}.
