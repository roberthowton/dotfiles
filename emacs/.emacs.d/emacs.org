...
Syntaxi highlighting and browser for gemini internet protocol
...
Workaround for inaccessible pinentry dialogue in exwm. (Make sure you have =pinentry-tty= installed.)
#+begin_src emacs-lisp
...
# #+begin_src scheme :tangle /home/rfh/.config/guix/manifests/emacs.scm :noweb yes
